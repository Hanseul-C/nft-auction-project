	...
	<section class="section" style="text-align: center;">
		<div id="page-wrapper">
			...
			<div id="page-content-wrapper" style="text-align: left;">
				<div class="container-fluid">
					<h1>${vo.memberId }님, 정말 회원을 탈퇴하시겠습니까?</h1>
					<hr>
				</div>
			</div>
						...
						<div class="card ">
							<div class="card-body p-3 m-5">
								...
								<form action="delete" method="post">
									비밀번호 <br> 
									<input type="password" class="form-control" id="member_pw" name="memberPassword" placeholder="비밀번호 입력" required> 
									<br>
									<input type="submit" class="btn btn-primary" value="탈퇴하기" id="btn-delete">
								</form>
							</div>
						</div>
					</div>
